...
<style lang="scss" scoped>
  $blue: #1890ff;
  .tabs-nav {position: relative;display: flex;border-bottom: 1px solid rgb(232, 232, 232);
    // 尽量用子元素选择器
    > .actions-wrapper {margin-left: auto;display: flex;align-items: center;}
    > .line-wrapper {position: absolute;bottom: 0;height: 2px;
      /* 这里的宽度也是动态生成的，所以transition要设置all */
      /*动态生成的属性：1. width 2. left*/
      transition: all .4s;
    }
    .line {height: 100%;width: 100%;margin: 0 auto;
